...
$result4=mysqli_query($a,$sql4);
}

// count more value
$addview=$view+1;
$sql5="update $tbl_name set view='$addview' WHERE id='$id'";
$result5=mysqli_query($a,$sql5);
mysqli_close($a);
?>
...
<tr>
<td align="top"><strong>Answer</strong></td>
<td align="top">:</td>
...
<?php
echo "<a href='main_forum.php?id=".$id."'>View all topics</a>";
?>
</body>
</html>